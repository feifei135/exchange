    ...
    <div class="c_my_focus">
        ...
        <div class="lty_container">
            <div class="g_wrap">
                ...
                <div class="uc_main">
                    <!-- uc_main_title -->
                    <div class="ucm_title">我的关注</div>

                    <!-- 我的关注列表 -->
                    <div class="uc_list_lty">
                        <ul class="clearfix">
                            <li>
                                <img src="../../assets/images/sm_gg3.jpg">
                                <h3><span>挂单标题</span><a href="#">查看</a></h3>
                                <p>￥2600.00 <span>删除</span></p>
                            </li>
                            <li>
                                <img src="../../assets/images/sm_gg3.jpg">
                                <h3><span>挂单标题</span><a href="#">查看</a></h3>
...
<style>
    @import "../../assets/css/uc/uc_list_lty.css";
</style>